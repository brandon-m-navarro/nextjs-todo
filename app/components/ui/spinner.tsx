...
export default function SpinnerComponent({
  ...
  const { isShowing, isLoading, isSuccess, isError, arcPercentage } =
    spinnerState;
  ...
  useEffect(() => {
    ...
    // Animation is canceled on cleanup
    return () => {};
  ...
  const strokeDasharray = `${
    (arcPercentage / 100) * circumference
  } ${circumference}`;
        ...
        >
          <svg
            ...
            style={{
              ...
              transition:
                currentRotation === 0 ? "transform 0.3s ease-out" : "none",
            }}
          >
            {/* Background circle */}
            <circle
