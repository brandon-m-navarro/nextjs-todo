...
export default function SimpleAnimation() {
    return (
        ...
        {/*left*/} <div className='skewed-45 bg-[#FFFFFF] absolute top-[50px] right-[24px] border-t-[0px] border-r-[0px] border-[#000000] border-[2px] h-[52px] w-[100px] rotate-z-45'></div>
        {/*right*/}<div className='bg-[#A66CFF] z-4 absolute top-[-34px] right-[-56px] rotate-z-[45deg] w-[130px] h-[104px] border-[2px] border-[#000000]'></div>
                </div>
        ...
        {/*right*/}<div className='skewed-45-reverse bg-[#A66CFF] absolute top-[27px] left-[50px] border-[#000000] border-b-[0px] border-l-[0px] border-[2px] h-[99px] w-[53px]'></div>
