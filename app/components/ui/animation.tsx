...
export default function SimpleAnimation() {
    return (
        <div className="animation-container mt-[24px] h-[250px] w-full relative">
        ...
        {/*top*/}  <div className='bg-[#000000] z-5 absolute rounded-[0px 0px 0px 4px] w-[100px] h-[50px]'></div>
        {/*left*/} <div className='skewed-45 bg-[#FFFFFF] absolute top-[50px] right-[22px] border-t-[0px] border-r-[0px] border-[#000000] border-[2px] h-[50px] w-[100px] rotate-z-45'></div>
        {/*right*/}<div className='bg-[#A66CFF] z-4 absolute top-[-34px] right-[-63px] rotate-z-[45deg] w-[130px] h-[104px] border-[2px] border-[#000000]'></div>
                </div>

                {/* Left trapezoid prism */}
                <div className='trapezoid-l z-2 w-[50px] h-[150px] absolute left-[0px] bottom-[0px]'>
        {/*top*/}  <div className='bg-[#000000] z-5 absolute rounded-[0px 0px 0px 4px] w-[50px] h-[100px]'></div>
        {/*right*/}<div className='skewed-45-reverse bg-[#A66CFF] absolute top-[26px] left-[50px] border-[#000000] border-b-[0px] border-l-[0px] border-[2px] h-[100px] w-[50px]'></div>
        {/*left*/} <div className='bg-[#FFFFFF] z-4 absolute top-[90px] right-[-36px] rotate-z-[45deg] w-[130px] h-[104px] border-[2px] border-[#000000]'></div>
                </div>

                {/* Center Base */}
                <div>
                    <div className='absolute w-[100px] h-[100px] left-[50%] top-[50%] bg-[#000000] rounded-[4px]'/>
                    <div className='skewed-45 absolute bottom-[-3px] right-[11px] border-[#000000] border-[2px] z-1 h-[26px] w-[96px] rounded-tl-[4px] bg-[#FFFFFF]'/>
                    <div className='skewed-45-reverse absolute bottom-[11px] right-[-3px] border-[#000000] border-[2px] z-1 w-[26px] h-[96px] rounded-tl-[4px] bg-[#A66CFF]'/>
